...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Task Closer Installer</title>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <form action="check.php" method="post">
                            ...
                            <p class="login-box-msg">Task Closer Admin</p>
                    ...
                    <div class="col-xs-6">
                        ...
                        <?php if (version_compare(PHP_VERSION, '5.4.0', '<')) { ?>
                            <div class="alert alert-danger">
                                ...
                                Task Closer requires PHP 5.4.0 or later.<br>Your version is <?php echo PHP_VERSION; ?>.
                            </div>
                        <?php } else { ?>
